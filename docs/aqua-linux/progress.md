...
1. Move to a supported Buildroot LTS and establish the unprivileged session and supervision prerequisites from ADR 0004 before packaging PipeWire, WirePlumber, ALSA, and the Aqua audio adapter.
