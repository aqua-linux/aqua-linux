...
1. Select the real audio service/backend through an ADR, then prove R4 output, input, mute, volume, and routing behavior without treating the Settings preference model as playback or hardware evidence.
