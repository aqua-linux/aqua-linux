...
1. Add an opt-in audio rootfs contract around the completed native WirePlumber binding, then collect declared-device QEMU media evidence without enabling audio packages by default.
