...
1. Implement the native PipeWire/WirePlumber library binding behind the typed transport, then add an opt-in rootfs contract and declared-device QEMU media evidence without enabling audio packages by default.
