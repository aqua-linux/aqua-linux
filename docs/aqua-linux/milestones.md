...
search field, list row, and sidebar navigation are host-proven across their
applicable states, four themes, three required viewports, and a fractional
scale. Installer, Applications, Global Search, Settings, and Files consume
them; shared geometry drives both renderer and input routing. Packaged-QEMU
component acceptance and the remaining catalog entries stay open.
