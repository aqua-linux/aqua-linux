...
- Language, Keyboard, Time Zone, and Partitions consume Up, Down, Home, and End through their bounded form navigation while visible Step Content focus is active. Choice values remain catalog-validated, disk navigation skips blocked targets, and Tab performs the footer focus handoff.
