...
- Language, Keyboard, Time Zone, and Partitions consume Up and Down through their bounded form navigation while visible Step Content focus is active. Choice values remain catalog-validated and disk navigation skips blocked targets.
