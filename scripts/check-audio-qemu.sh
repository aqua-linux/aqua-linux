...
case "${AQUA_AUDIO_QEMU_CONTRACT}" in
    output|input|input-signal|input-disconnect|active-input-unplug|service-loss|policy-service-loss|capture-service-loss|capture-policy-service-loss|control-service-loss|restart-exhaustion|capture-restart-exhaustion|policy-restart-exhaustion|multi-route|hotplug|replug|nondefault-unplug|active-nondefault-unplug|active-default-unplug) ;;
    *)
