...
LIGHT_SCREENSHOT="${LIGHT_SCREENSHOT:-${ROOT_DIR}/build/qemu-theme-light.ppm}"
LIGHT_SCREENSHOT_PNG="${LIGHT_SCREENSHOT_PNG:-${ROOT_DIR}/build/qemu-theme-light.png}"
DEEP_SCREENSHOT="${DEEP_SCREENSHOT:-${ROOT_DIR}/build/qemu-theme-dark.ppm}"
DEEP_SCREENSHOT_PNG="${DEEP_SCREENSHOT_PNG:-${ROOT_DIR}/build/qemu-theme-dark.png}"
...
echo "Light screenshot: ${LIGHT_SCREENSHOT_PNG}"
echo "Dark screenshot: ${DEEP_SCREENSHOT_PNG}"
