...
EXPECTED_FRAME_CHECKSUM="${AQUA_EXPECTED_FRAME_CHECKSUM:-1767f1f782a5cdb8}"
...
need_marker 'gpu_scene_surface_count=7'
need_marker 'gpu_scene_surface_layer_count=5'
need_marker 'gpu_scene_shader=aqua-surface-compositor-v1'
need_marker 'gpu_surface_shader_compiled=true'
need_marker 'gpu_surface_shader_panels=5'
...
need_marker 'wayland_socket=/run/aqua/aqua-wayland-drm-0'
...
need_marker 'drm_wayland_composition_backend=smithay-gles2-gbm'
need_marker 'drm_wayland_gpu_render_device=/dev/dri/card0'
need_marker 'drm_wayland_gpu_render_node_separate=false'
need_marker 'drm_wayland_scanout_bridge=gbm-dmabuf-direct'
need_marker 'drm_wayland_scanout_cpu_copy=false'
need_marker 'drm_wayland_direct_dmabuf_scanout=true'
need_marker 'drm_wayland_gpu_frame_readback=false'
need_marker 'drm_wayland_gpu_checksum_source=surface-inputs'
...
need_numeric_marker_min 'drm_wayland_input_pointer_button_events=' 19
...
need_marker 'drm_wayland_launcher_pointer_hits=2'
need_marker 'drm_wayland_launcher_category_clicks=1'
