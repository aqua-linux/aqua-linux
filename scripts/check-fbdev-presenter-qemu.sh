...
need_marker 'aqua_settings_loaded_desktop_icons=false'
need_marker 'aqua_settings_loaded_key_repeat=true'
need_marker 'aqua_settings_loaded_theme=Light'
...
need_marker 'drm_wayland_settings_desktop_icons=true'
need_marker 'drm_wayland_settings_desktop_toggle_checksum='
need_marker 'drm_wayland_settings_persisted_desktop_icons=true'
...
need_marker 'aqua_files_axis value=0 navigation=None view=list offset=1 repaint=false'
need_marker 'aqua_files_axis value=0 navigation=None view=preview offset=1 repaint=false'
need_marker 'drm_wayland_files_list_zero_axis_stable=true'
need_marker 'drm_wayland_files_list_zero_axis_damage_delta=0'
need_marker 'drm_wayland_files_list_axis_reverse_restored=true'
need_marker 'drm_wayland_files_preview_zero_axis_stable=true'
need_marker 'drm_wayland_files_preview_zero_axis_damage_delta=0'
need_marker 'drm_wayland_files_preview_axis_reverse_restored=true'
