...
MODES = {
    ...
    "files-pointer-leave": (
        "mouse_move -3000 -3000", "mouse_move 220 250",
        "mouse_move 300 0",
    ),
    ...
    "public-search-no-results": (
        "sendkey x 100", "sendkey y 100", "sendkey z 100",
    ),
    "public-search-restore": (
        "sendkey backspace 100", "sendkey backspace 100", "sendkey backspace 100",
    ),
    ...
    "installer-pointer-language-drag-cancel": (
        "mouse_move 336 252",
        "mouse_button 2", "mouse_button 0",
        "mouse_button 1", "mouse_move -336 -252", "mouse_button 0",
    ),
