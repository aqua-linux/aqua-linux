...
SCREENSHOT_light="${SCREENSHOT_light:-${ROOT_DIR}/build/qemu-elevation-light.ppm}"
SCREENSHOT_light_PNG="${SCREENSHOT_light_PNG:-${ROOT_DIR}/build/qemu-elevation-light.png}"
SCREENSHOT_dark="${SCREENSHOT_dark:-${ROOT_DIR}/build/qemu-elevation-dark.ppm}"
SCREENSHOT_dark_PNG="${SCREENSHOT_dark_PNG:-${ROOT_DIR}/build/qemu-elevation-dark.png}"
...
for marker, expected in (
    ("elevation_wayland_surface_ready=true", 2),
    ("elevation_wayland_focused_surface_count=1", 2),
    ("elevation_wayland_inactive_surface_count=1", 2),
    ("gpu_shadow_mask_cache_misses=2", 2),
    ("gpu_shadow_damage_rects=2", 2),
    ("elevation_wayland_client_process_stopped=true", 4),
