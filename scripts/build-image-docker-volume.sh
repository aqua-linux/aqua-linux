...
docker run --rm \
    ...
    /bin/bash -lc '
        ...
        if [ -f /src/target/x86_64-unknown-linux-musl/release/aqua-component-acceptance ]; then
            mkdir -p /work/target/x86_64-unknown-linux-musl/release
            cp /src/target/x86_64-unknown-linux-musl/release/aqua-component-acceptance \
                /work/target/x86_64-unknown-linux-musl/release/aqua-component-acceptance
        fi
