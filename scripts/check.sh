...
grep -Fq 'shared_button=true hover=true action=refresh-contents' scripts/check-graphical-boot-qemu.sh
...
grep -Fq 'shared_button=true hover=true action=refresh-contents' scripts/check-graphical-boot-qemu.exp
