...
cargo test -p aqua-compositor --features smithay-smoke shared_pointer_leave
...
AQUA_TRASH_ROOT="${CHECK_TEMP_ROOT}/shared-buffer-trash" cargo test -p aqua-compositor --features smithay-smoke shared_buffer_release
...
grep -Fq 'installer-keyboard-choice-arrows' scripts/send-qemu-monitor-input.py
...
grep -Fq 'installer-summary-confirmation-field' scripts/send-qemu-monitor-input.py
...
grep -Fq 'target=Some\(SummaryConfirmationField\)' scripts/check-installer-wayland-qemu.sh
grep -Fq 'aqua_installer_form_navigation key=108' scripts/check-installer-wayland-qemu.sh
grep -Fq 'aqua_installer_form_navigation key=103' scripts/check-installer-wayland-qemu.sh
grep -Fq 'aqua_installer_redraw_count=57' scripts/check-installer-wayland-qemu.sh
...
grep -Fq 'snapshot.keyboard_event_count >= 112' crates/aqua-compositor/src/main.rs
...
grep -Fq 'model.section_group_in_viewport(width, height)' crates/aqua-renderer/src/lib.rs
grep -Fq 'SETTINGS_ABOUT_METADATA' crates/aqua-shell/src/lib.rs
...
grep -Fq 'properties-nonprimary-pointer' scripts/send-qemu-monitor-input.py
grep -Fq 'desktop-properties-primary-button-qemu status=ok' scripts/check-graphical-boot-qemu.sh
grep -Fq 'desktop-properties-primary-button-qemu status=ok' scripts/check-graphical-boot-qemu.exp
...
grep -Fq 'files-keyboard-focus' scripts/send-qemu-monitor-input.py
...
grep -Fq 'files-pointer-leave' scripts/send-qemu-monitor-input.py
grep -Fq 'desktop-files-pointer-leave-qemu status=ok' scripts/check-graphical-boot-qemu.sh
grep -Fq 'desktop-files-pointer-leave-qemu status=ok' scripts/check-graphical-boot-qemu.exp
...
grep -Fq 'settings-keyboard-refocus' scripts/send-qemu-monitor-input.py
grep -Fq 'desktop-settings-pointer-blur-qemu status=ok' scripts/check-graphical-boot-qemu.sh
grep -Fq 'desktop-settings-pointer-blur-qemu status=ok' scripts/check-graphical-boot-qemu.exp
...
grep -Fq 'files_preview_layout(width, height)' crates/aqua-renderer/src/lib.rs
