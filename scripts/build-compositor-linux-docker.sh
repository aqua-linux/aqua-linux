...
echo "  ${ROOT_DIR}/target/${TARGET_TRIPLE}/release/aqua-typography-acceptance"
echo "Aqua component acceptance Wayland binary:"
echo "  ${ROOT_DIR}/target/${TARGET_TRIPLE}/release/aqua-component-acceptance"
