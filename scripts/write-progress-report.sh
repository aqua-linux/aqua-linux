...
lines = [
    ...
    "",
    f"**Roadmap implementation progress: {int(data['overallPercent'])}%**",
    "",
    "| Field | Value |",
    "| --- | --- |",
    ...
    "| Field | Value |",
    "| --- | --- |",
    f"| Classification | {cell(data['readiness']['classification'])} |",
    f"| Evidence level | {cell(data['readiness']['evidenceLevel'])} |",
    f"| Daily-use ready | {'Yes' if data['readiness']['dailyUseReady'] else 'No'} |",
    f"| Hardware-proven | {'Yes' if data['readiness']['hardwareProven'] else 'No'} |",
    f"| Release-ready | {'Yes' if data['readiness']['releaseReady'] else 'No'} |",
    f"| Summary | {cell(data['readiness']['summary'])} |",
    "",
    "## Current Stage",
    "",
