...
TEMP_ICON_DIR="${ASSET_DIR}/temp-icons/lucide"
...
need_file "${ASSET_DIR}/temp-icons/README.md"

need_file "${TEMP_ICON_DIR}/LICENSE"
need_file "${TEMP_ICON_DIR}/home.svg"
need_file "${TEMP_ICON_DIR}/files.svg"
need_file "${TEMP_ICON_DIR}/aqua-drive.svg"
need_file "${TEMP_ICON_DIR}/trash.svg"
need_file "${TEMP_ICON_DIR}/browser.svg"
need_file "${TEMP_ICON_DIR}/terminal.svg"
need_file "${TEMP_ICON_DIR}/settings.svg"
need_file "${TEMP_ICON_DIR}/software.svg"
need_file "${TEMP_ICON_DIR}/wifi.svg"
need_file "${TEMP_ICON_DIR}/volume.svg"
need_file "${TEMP_ICON_DIR}/battery.svg"
need_file "${TEMP_ICON_DIR}/notification.svg"
need_file "${TEMP_ICON_DIR}/updates.svg"
...
need_text "${ROOT_DIR}/docs/aqua-linux/design-tokens.json" "\"defaultTheme\": \"LightWhite\""
need_text "${ROOT_DIR}/docs/aqua-linux/design-tokens.json" "\"Softtouch\""
...
need_text "${ROOT_DIR}/THIRD_PARTY_LICENSES.md" "Lucide Icons"
