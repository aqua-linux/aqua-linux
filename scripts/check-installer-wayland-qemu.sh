...
need_marker 'aqua_installer_keyboard key=57 press_count=65 action=FinishRequested'
need_marker 'aqua_installer_finish_requested=true'
need_marker 'aqua_installer_redraw_count=72'
