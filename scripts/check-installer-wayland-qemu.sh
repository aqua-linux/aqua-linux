...
need_regex 'aqua_installer_hover x=[0-9]+ y=[0-9]+ hovered=forward reason=pointer-motion repaint=true'
need_regex 'aqua_installer_pointer phase=press button=[0-9]+ primary=false ignored=true'
need_regex 'aqua_installer_pointer phase=press x=[0-9]+ y=[0-9]+ pressed=true focus=forward action=none repaint=true'
need_regex 'aqua_installer_pointer phase=release x=[0-9]+ y=[0-9]+ pressed=false action=AdvanceRequested'
need_regex 'aqua_installer_pointer phase=press x=[0-9]+ y=[0-9]+ pressed=false focus=none action=none repaint=true'
need_regex 'aqua_installer_keyboard key=28 press_count=[0-9]+ action=None'
need_regex 'aqua_installer_content_hover x=[0-9]+ y=[0-9]+ hovered=Some\(Choice \{ step: Language, index: 0 \}\) reason=pointer-motion repaint=true'
...
need_marker 'aqua_installer_form_navigation key=108 press_count=6 update=SelectionChanged { step: Keyboard, index: 1, value: "trf" }'
need_marker 'aqua_installer_form_navigation key=103 press_count=7 update=SelectionChanged { step: Keyboard, index: 0, value: "trq" }'
...
need_regex 'aqua_installer_content_hover x=[0-9]+ y=[0-9]+ hovered=Some\(SummaryAcknowledgement\) reason=pointer-motion repaint=true'
need_regex 'aqua_installer_pointer phase=press x=[0-9]+ y=[0-9]+ pressed=true target=SummaryAcknowledgement action=FocusChanged\(StepContent\) content=true repaint=true'
need_regex 'aqua_installer_pointer phase=release x=[0-9]+ y=[0-9]+ pressed=false target=Some\(SummaryAcknowledgement\) content=true'
need_regex 'aqua_installer_content_hover x=[0-9]+ y=[0-9]+ hovered=Some\(SummaryConfirmationField\) reason=pointer-motion repaint=true'
need_regex 'aqua_installer_pointer phase=press x=[0-9]+ y=[0-9]+ pressed=true target=SummaryConfirmationField action=FocusChanged\(StepContent\) content=true repaint=true'
need_regex 'aqua_installer_pointer phase=release x=[0-9]+ y=[0-9]+ pressed=false target=Some\(SummaryConfirmationField\) content=true'
need_marker 'aqua_installer_pointer_summary_update=FocusChanged(ConfirmationField)'
...
need_marker 'aqua_installer_redraw_count=57'
